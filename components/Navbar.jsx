                ...
                <div className="flex items-center justify-between max-w-7xl mx-auto py-4  transition-all">
                    ...
                    <div className="hidden sm:flex items-center gap-4 lg:gap-8 text-slate-600">
                        ...
                        <Link href="/cart" className="relative flex items-center gap-2 text-slate-600">
                            ...
                            left-3 text-[8px] text-white *: bg-slate-600 size-3.5 
                            rounded-full">{cartCount}</button>
                        </Link>
                        {
                            !user ? (
                                <button onClick={openSignIn} className="px-8 py-2 bg-indigo-500
                    ...
                    <div className="sm:hidden">
                        {  user ? (
                           <div>
                            ...
                            <button onClick={openSignIn} className="px-7 py-1.5 bg-indigo-500
                         hover:bg-indigo-600 
                         text-sm transition text-white rounded-full">
                            Login
                        </button>
                        )
